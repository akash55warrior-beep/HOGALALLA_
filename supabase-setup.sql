...
-- 4. Create
--
-- IMPORTANT: "Public bucket" only allows people to VIEW files.
-- You also need this policy so the admin panel can UPLOAD to it —
-- run this in SQL Editor AFTER creating the bucket above:
-- ============================================
